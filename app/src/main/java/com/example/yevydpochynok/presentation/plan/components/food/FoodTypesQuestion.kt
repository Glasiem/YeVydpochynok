...
fun FoodTypesQuestion(
    ...
    Column(
        ...
        Text(
            text = "Оберіть декілька типів їжі яким ви надаєте перевагу (зважаючи також на дієтичні особливості)! Не обирайте жоден елемент якщо цей параметр для вас неважливий.",
            fontSize = 16.sp,
        ...
        Button(
            onClick = {
                viewModel.send(PlanViewModel.Event.OnFoodTypesAnswer(selectedValues))
